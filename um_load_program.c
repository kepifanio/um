 ...
 * Does: It reads the file with the instructions in it and determines the number of instructions as well as stores them to be read
 ...
 * Does: takes the instruction from the file and formats it to be a UM-readable instruction
